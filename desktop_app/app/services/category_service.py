...
class CategoryService:
    ...
    def update_category(self, category_id: str, name: str, category_type: str) -> Category:
        with unit_of_work(self.db):
    ...
    def category_id_for_input(self, value: object, category_type: str) -> str | None:
        if value is None:
            return None
        if isinstance(value, (str, int)):
            category = self.categories.get(str(value))
        else:
            category = None
        if category:
